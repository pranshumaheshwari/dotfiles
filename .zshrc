...
if zplug check "bhilburn/powerlevel9k"; then
    ...
    P9K_RIGHT_PROMPT_ELEMENTS=(status background_jobs command_execution_time time battery)
    ...
    # battery
    # P9K_BATTERY_LOW_BACKGROUND='none'
    P9K_BATTERY_LOW_FOREGROUND='001'
    # P9K_BATTERY_CHARGING_BACKGROUND='none'
    P9K_BATTERY_CHARGING_FOREGROUND='076'
    # P9K_BATTERY_CHARGED_BACKGROUND='none'
    P9K_BATTERY_CHARGED_FOREGROUND='076'
    # P9K_BATTERY_DISCONNECTED_BACKGROUND='none'
    P9K_BATTERY_DISCONNECTED_FOREGROUND='003'
